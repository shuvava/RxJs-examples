...
myObservable.subscribe(o => console.log(`MY_OBSERVABLE ${o}`));
console.log('MULTIPLY_OBSERVABLE');
multiplyObservable.subscribe(o => console.log(`MULTIPLY_OBSERVABLE ${o}`));
console.log('FILTER_OBSERVABLE');
filterObservable.subscribe(o => console.log(`FILTER_OBSERVABLE ${o}`));
